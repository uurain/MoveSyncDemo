...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetSaveDataManager", GetSaveDataManager);
	...
	static int GetResManager(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			ResManager o = LuaFramework.LuaHelper.GetResManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetSaveDataManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			SaveDataManager o = LuaFramework.LuaHelper.GetSaveDataManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetGameSceneManager(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			pg.GameSceneMgr o = LuaFramework.LuaHelper.GetGameSceneManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
