...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(SaveDataManager)),

        //_GT(typeof(ETCJoystick)),
        //_GT(typeof(ETCJoystick.OnMoveHandler)),
        //_GT(typeof(ETCAxis)),
        _GT(typeof(UnityEngine.AI.NavMeshAgent)),
        //_GT(typeof(BattleLogic_)),
        _GT(typeof(StaticDataManager)),
        _GT(typeof(Tangzx.ABSystem.AssetBundleInfo)),

        //myself
        _GT(typeof(GameSceneMgr)),
        _GT(typeof(AssetObject)),
        _GT(typeof(PgJoystick)),
