...
public class Packager {
    ...
    public static void BuildProtobufCFile() {
        //if (!AppConst.ExampleMode) {
        //    UnityEngine.Debug.LogError("若使用编码Protobuf-lua-gen功能，需要自己配置外部环境！！");
        //    return;
        //}
        string dir = "../../../NoahGameFrame-master/NFComm/NFMessageDefine/";// AppDataPath + "/LuaFramework/Lua/3rd/pblua";
        paths.Clear(); files.Clear(); Recursive(dir);

        string protoc = "D:/NAME_TEMP/src/client/protoc-gen-lua/example/protoc.exe";
        string protoc_gen_dir = "\"D:/NAME_TEMP/src/client/protoc-gen-lua/plugin/build.bat\"";

        string outputDir = AppDataPath + "/LuaFramework/Lua/Protocol/Pbc/";
        ...
        foreach (string f in files) {
            ...
            info.Arguments = " --descriptor_set_out=" + outputDir + prefix + ".pb --proto_path " + dir + " " + f;
            info.WindowStyle = ProcessWindowStyle.Hidden;
            info.UseShellExecute = true;
            info.WorkingDirectory = dir;
            info.ErrorDialog = true;
        ...
        BuildProtobufFileLua();
        AssetDatabase.Refresh();
    }

    public static void BuildProtobufFileLua()
    {
        string dir = "../../comm/";// AppDataPath + "/LuaFramework/Lua/3rd/pblua";
        paths.Clear(); files.Clear(); Recursive(dir);

        string protoc = "../protoc-gen-lua/example/protoc.exe";
        string protoc_gen_dir = "\"../protoc-gen-lua/plugin/build.bat\"";

        string outputDir = AppDataPath + "/LuaFramework/Lua/Protocol/PbLua/";
